...
#MUCH OF THIS WAS PUT TOGETHER WITH AI. I RESTRUCTURED TO TAKE INPUT FROM THE COMMAND LINE. SEE quickADA.py for input form the user. This script also overwrites files instead of creating new ones.
#for my purposes i ran this code by executing this powershell script
#Note that the document titles created by my script are really just the name of the file, but spaced out.
...
#output_file = 'churro.pdf'




pattern = r'(?i)(?<=\\)[^\\]+(?=\.pdf$)'  # (?i) makes it case-insensitive
...
#new_title = input_file.replace("_", " ")# just testing this
new_title = name.replace("_", " ")# just testing this
